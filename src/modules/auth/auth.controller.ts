...
export class AuthController {
    ...
    async register(@Body() registerDto: RegisterDto, @Res({ passthrough: true }) res: Response) {
        ...
        return ApiResponse.created({ user: data.user, accessToken: data.accessToken }, "User registered successfully");
    }
    ...
    async login(@Body() loginDto: LoginDto, @Req() req: Request, @Res({ passthrough: true }) res: Response) {
        ...
        res.cookie("refreshToken", data.refreshToken, this.getCookieOptions());
        return ApiResponse.success({ user: data.user, accessToken: data.accessToken }, "Login successfully");
    }
    ...
    async refreshToken(@Req() req: Request, @Res({ passthrough: true }) res: Response) {
        ...
        const data = await this.authService.refreshToken(incomingRefreshToken, userAgent, ipAddress);

        res.cookie("refreshToken", data.refreshToken, this.getCookieOptions());
        return ApiResponse.success({ accessToken: data.accessToken }, "Token refreshed successfully");
    }
    ...
    @ApiOperation({ summary: "Initiate LinkedIn Login" })
    @Get("linkedin")
